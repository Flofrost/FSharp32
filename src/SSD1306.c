...
// <------  Down
const uint8_t charmap[95][6] PROGMEM = {
    ...
    {0x04, 0x2A, 0x7F, 0x2A, 0x10, 0x00},            // Code for char $
    {0x46, 0x30, 0x08, 0x06, 0x31, 0x00},            // Code for char %
    ...
    {0x00, 0x40, 0x30, 0x00, 0x00, 0x00},            // Code for char ,
    ...
    {0x41, 0x21, 0x19, 0x05, 0x03, 0x00},            // Code for char 7
    ...
    {0x00, 0x40, 0x36, 0x00, 0x00, 0x00},            // Code for char ;
    ...
    {0x3E, 0x41, 0x4D, 0x49, 0x2E, 0x00},            // Code for char @
    ...
    {0x21, 0x41, 0x41, 0x3F, 0x01, 0x00},            // Code for char J
    ...
    {0x7F, 0x02, 0x1C, 0x20, 0x7F, 0x00},            // Code for char N
    ...
    {0x41, 0x36, 0x08, 0x36, 0x41, 0x00},            // Code for char X
    {0x01, 0x06, 0x78, 0x06, 0x01, 0x00},            // Code for char Y
    ...
    {0x7C, 0x50, 0x50, 0x50, 0x20, 0x00},            // Code for char b
    {0x38, 0x44, 0x44, 0x44, 0x28, 0x00},            // Code for char c
    {0x20, 0x50, 0x50, 0x50, 0x7C, 0x00},            // Code for char d
    {0x38, 0x54, 0x54, 0x54, 0x58, 0x00},            // Code for char e
    {0x00, 0x78, 0x14, 0x04, 0x00, 0x00},            // Code for char f
    {0x08, 0x54, 0x54, 0x54, 0x3C, 0x00},            // Code for char g
    {0x7C, 0x10, 0x10, 0x10, 0x60, 0x00},            // Code for char h
    {0x00, 0x00, 0x74, 0x00, 0x00, 0x00},            // Code for char i
    {0x00, 0x40, 0x34, 0x00, 0x00, 0x00},            // Code for char j
    {0x7C, 0x10, 0x28, 0x44, 0x00, 0x00},            // Code for char k
    {0x00, 0x00, 0x3C, 0x40, 0x00, 0x00},            // Code for char l
    {0x7C, 0x04, 0x18, 0x04, 0x78, 0x00},            // Code for char m
    {0x7C, 0x04, 0x04, 0x04, 0x78, 0x00},            // Code for char n
    ...
    {0x7C, 0x08, 0x04, 0x04, 0x04, 0x00},            // Code for char r
    {0x48, 0x54, 0x54, 0x54, 0x24, 0x00},            // Code for char s
    {0x00, 0x3C, 0x48, 0x40, 0x00, 0x00},            // Code for char t
    {0x3C, 0x40, 0x40, 0x40, 0x7C, 0x00},            // Code for char u
    {0x0C, 0x30, 0x40, 0x30, 0x0C, 0x00},            // Code for char v
    {0x7C, 0x40, 0x30, 0x40, 0x3C, 0x00},            // Code for char w
    {0x44, 0x28, 0x10, 0x28, 0x44, 0x00},            // Code for char x
    {0x04, 0x48, 0x30, 0x08, 0x04, 0x00},            // Code for char y
...
void printStr_SSD1306(uint8_t x, uint8_t y, char* s, uint8_t flags){
    ...
    for(uint8_t i = 0 ; s[i] ; i++)
        for(uint8_t col = 0 ; col < 6 ; col++){
            uint8_t byte = pgm_read_byte(&charmap[s[i] - 0x20][col]);
            if(flags & ATTR_UNDERLINE) byte |= 0x80;
            if(flags & ATTR_STRICKTHR) byte |= 0x08;
            if(flags & ATTR_INVERTED) byte = ~byte;
            I2C_WRITE(byte);
